...
public class SampleAPIMapCreator : MonoBehaviour
{
	...
	private ArcGISPoint geographicCoordinates = new ArcGISPoint(-71.087685, 42.360807, 3000, ArcGISSpatialReference.WGS84());
	...
	public void CreateArcGISMap()
	{
		...
		if (arcGISMap.MapType == Esri.GameEngine.Map.ArcGISMapType.Local)
		{
			...
			var extentCenter = new Esri.GameEngine.Geometry.ArcGISPoint(-71.087685, 42.360807, 3000, ArcGISSpatialReference.WGS84());
